...
```{r kgml-parsing}
nodes_df <- parse_kgml_entries(system.file("extdata/kgml/hsa04060.xml", package = "KEGGemUP"))
edges_df <- parse_kgml_relations(system.file("extdata/kgml/hsa04060.xml", package = "KEGGemUP"))
