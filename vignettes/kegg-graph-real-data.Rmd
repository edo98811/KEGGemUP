...
KEGG pathways are used in may bioinformatics contexts, this package package can make it very easy to implement these in the analysis of real data.
...
You can use these functions to parse KGML files directly. From these you can build a graph object if you wish to do so and you have expertese with graph analysis in R.
...
Note that the KEGG IDs without organism prefix are the the ENTREZ IDs for genes.
