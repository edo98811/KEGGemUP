...
To use it with a single differential expression results table: Make sure
there are the two dfault columns: “KEGG_ids” for the kegg ids and
“log2FoldChange” for the values to map.
